-- ============================================================================
-- Analytics-Weddings — ww2_drill_down v3 (adiciona ac_deal_id)
--
-- Preserva todos os campos da v2 (20260527s_ww2_drill_down_enrich.sql):
--   contato_id, contato_nome, contato_email, contato_telefone,
--   contato_external_id, data_venda, monde_venda, tipo_casamento,
--   campaign, medium, content, dias_parado, motivo_perda
--
-- NOVO v3: ac_deal_id (de marketing_data->>'active_campaign_id') para deep-link
-- abrir o DEAL no ActiveCampaign (em vez do contato).
-- ============================================================================
