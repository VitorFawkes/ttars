-- ============================================================================
-- MIGRATION: fn_roteamento_pos_venda_trips_diagnose — usar stage_entered_at e ordenar
-- Date: 2026-05-05
--
-- Troca c_atualizado_em por c_bloqueado_em (= stage_entered_at, com fallback
-- para updated_at). Significado: "está parado nessa etapa desde X" — é o que
-- o gestor precisa pra priorizar.
--
-- Ordena do mais novo pro mais antigo: casos recém-bloqueados aparecem primeiro.
-- ============================================================================
