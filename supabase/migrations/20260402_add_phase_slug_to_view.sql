-- ============================================================================
-- ADD phase_slug to view_cards_acoes
--
-- The view already JOINs pipeline_stages (s), but not pipeline_phases.
-- This adds:
--   1. LEFT JOIN pipeline_phases pp ON s.phase_id = pp.id
--   2. pp.slug AS phase_slug in SELECT
--
-- phase_slug is the invariant identifier for the phase (e.g. 'sdr',
-- 'planner', 'pos_venda'). Unlike s.fase (a free-text legacy field),
-- phase_slug is stable and safe for programmatic comparisons.
-- ============================================================================
