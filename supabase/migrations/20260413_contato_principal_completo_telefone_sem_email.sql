-- ============================================================================
-- MIGRATION: Regra contato_principal_completo troca email → telefone
-- Date: 2026-04-13
--
-- CONTEXTO
-- A regra contato_principal_completo exigia: nome, sobrenome, email, cpf.
-- Por decisão de produto, email passa a NÃO ser obrigatório e telefone
-- volta a ser. Os 4 campos exigidos passam a ser:
-- nome, sobrenome, telefone, cpf.
--
-- Atualiza só o validate_stage_requirements (frontend atualizado nos hooks
-- useQualityGate.ts e useStageRequirements.ts).
-- ============================================================================
