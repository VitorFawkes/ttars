-- ============================================================================
-- ww_funil_ranking_combo — sobe o LIMIT de 50 → 500.
--
-- POR QUÊ: o cruzamento personalizado (frontend) agrega as células cruas
-- (bucketA × bucketB) em grupos definidos pelo usuário. Pra essa soma fechar,
-- precisamos de TODAS as células do cruzamento, não só o top-50. faixa×destino
-- pode ter ~56 pares; 500 cobre qualquer cruzamento de 2 dimensões com folga.
-- (Só muda a constante do LIMIT; resto idêntico ao 20260531c.)
-- ============================================================================
