-- 20260616e_ww_funil_cohort_gateia_so_entrou.sql
--
-- BUG FIX: ao aplicar "Entrou DW = só SDR Weddings" (20260616a), o cohort INTEIRO das
-- conversoes do ww2_overview foi gateado por entrada_valida — zerando Marcou closer/Fez
-- closer/Ganhou no funil (casais que entraram por outra esteira e já estão adiantados saíram).
-- Contradição: KPI "fechados"=1 mas funil "Ganhou"=0.
--
-- FIX: cohort volta a ser COMPLETO; entrada_valida gateia APENAS o "Entrou" (igual aos KPIs
-- e ao funil_v1). Resultado jun/DW: Entrou 84, Marcou 26, Fez 10, Marcou closer 6, Fez closer 3,
-- Ganhou 1 — bate com os KPIs. Throughput, KPIs e funil_v1 já estavam certos; só o cohort
-- das conversoes do overview muda.
--
