-- ============================================================================
-- ww_funil_casal — adiciona as DIMENSÕES DE PERFIL que o funil filtra/ranqueia
-- (faixa, convidados, destino, origem, consultor), derivadas do cache por casal.
-- Recria refresh_ww_funil_casal() pra popular essas colunas junto (a função faz
-- DELETE+INSERT, então as dims têm que entrar no INSERT pra não se perderem).
-- ============================================================================

ALTER TABLE public.ww_funil_casal
...
BEGIN
    ...
    WITH ev AS (
        ...
        SELECT
            ...
            cf.consultor_id, cf.consultor_nome,
