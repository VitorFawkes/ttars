-- 20260616k_ww_serie_temporal_entrou_dw_so_sdr.sql
--
-- Reconcilia o gráfico "Ao longo do tempo" (ww_serie_temporal) com o resto da Visão Geral:
-- aplica a MESMA régua "Entrou DW = só SDR Weddings" (entrada_valida) que já está no
-- ww2_overview (KPIs + funil) e no ww_funil_conversao_v1. Gateia SÓ o "entrou"; os demais
-- marcos (marcadas/feitas/vendas) seguem a realidade. Antes: gráfico Leads=110 vs KPI/funil=87.
--
