-- =============================================================================
-- FIX: matched_trigger_id não sendo preenchido no trigger dinâmico
--
-- Problema: A versão dinâmica do trigger (20260206220002) chama
-- check_outbound_trigger() e recebe v_rule_result.rule_id, mas os INSERTs
-- na integration_outbound_queue NÃO incluem matched_trigger_id.
-- Resultado: todos os eventos ficam com matched_trigger_id = NULL,
-- e a UI de histórico não consegue associar eventos às regras.
--
-- Fix: Adicionar matched_trigger_id nos 4 INSERTs (stage_change, won, lost,
-- field_update) passando v_rule_result.rule_id.
-- =============================================================================
...
'Trigger dinâmico que monitora mudanças em cards sincronizados e enfileira eventos outbound.
Suporta: stage_change, won, lost, field_update (colunas diretas + JSONB).
Inclui matched_trigger_id para rastreamento de qual regra processou cada evento.';
