-- ============================================================================
-- FIX DEFINITIVO: criar_sub_card — remove overloads e corrige comparação de fase
--
-- Problemas encontrados:
--   1. 4 overloads no banco causando conflito PostgREST
--   2. Comparação de fase usava 'pos_venda' (slug) mas DB tem 'Pós-venda'
--   3. O frontend chamava overload errada (sem tarefa solicitacao_mudanca)
--
-- Solução: Drop ALL overloads, recriar UMA versão definitiva com:
--   - Todos os parâmetros (p_category, p_valor_estimado)
--   - Comparação correta: v_parent.fase = 'Pós-venda'
--   - Bloco de tarefa solicitacao_mudanca funcionando
-- ============================================================================

BEGIN;

-- 1. Dropar TODAS as overloads
