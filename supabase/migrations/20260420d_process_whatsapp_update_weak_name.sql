-- ============================================================================
-- Marco A — process_whatsapp_raw_event_v2 atualiza nome fraco de contato
-- Date: 2026-04-20
--
-- Base: 20260309_fix_whatsapp_status_fallthrough.sql
--
-- Mudança: após resolver/criar contato, se a mensagem é inbound, a flag
-- WHATSAPP_UPDATE_CONTACT está ativa, o nome atual do contato é fraco
-- (is_weak_contact_name = true), o campo nome_locked_at é NULL, e o
-- sender_name da mensagem é um nome válido — atualiza contatos.nome.
--
-- Para mensagens outbound o sender_name é o nome do agente (ex: "Mariana
-- Volpi"), não pode ser usado para atualizar o contato do cliente; por isso
-- o branch exige v_direction = 'inbound' AND NOT v_from_me.
-- ============================================================================
...
BEGIN
    ...
    -- ========================================
    -- UPDATE WEAK CONTACT NAME (Marco A)
    -- Só para inbound: v_sender_name é o nome do cliente.
    -- Em outbound, v_sender_name vira nome do agente mais abaixo, não pode
    -- ser usado para atualizar o contato.
    -- ========================================
    ...
    -- ========================================
    -- RESOLVE SENDER PROFILE (outbound)
    -- ========================================
...
'Processa evento WhatsApp. Marco A: atualiza contatos.nome quando fraco e sender_name é válido (inbound only), respeitando nome_locked_at.';
