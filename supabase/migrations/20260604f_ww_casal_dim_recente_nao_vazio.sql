-- ============================================================================
-- Refina 20260604e: o cadastro mais recente que TENHA valor vence (pula os em
-- BRANCO). Antes, se o deal mais recente tinha faixa_raw='' (vazio, comum quando
-- o casal nao respondeu o form naquele cadastro), o casal perdia o valor bom de
-- um cadastro mais antigo (regressao 'Ate R$50 mil' -> None). btrim(x) <> ''
-- exclui null E vazio/espacos de uma vez.
--
-- Recria refresh_ww_funil_casal IDENTICA a 20260604e, so trocando o FILTER das 4
-- dimensoes (faixa/convidados/destino/origem) de "IS NOT NULL" p/ "btrim <> ''".
-- ============================================================================
