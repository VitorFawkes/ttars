-- ============================================================
-- MIGRATION: Guard contra criação de cards duplicados
-- Date: 2026-03-13
--
-- Fixes:
-- 1. Lookup incondicional de card existente ANTES do auto-create
--    (independente de WHATSAPP_LINK_TO_CARD)
-- 2. Status events que caem no full processing não criam cards
-- ============================================================
...
BEGIN
    ...
    BEGIN
        ...
        -- Mesmo que WHATSAPP_LINK_TO_CARD esteja desabilitado, não criar card duplicado
        -- ========================================
