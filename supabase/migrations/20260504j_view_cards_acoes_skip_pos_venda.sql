-- ============================================================================
-- MIGRATION: view_cards_acoes — expor coluna skip_pos_venda
-- Date: 2026-05-04
--
-- A view view_cards_acoes alimenta o Kanban (usePipelineCards) e listas.
-- Sem a coluna skip_pos_venda exposta, o frontend não consegue distinguir
-- "Ganho com Pós-Venda" de "Ganho sem Pós-Venda" — todos aparecem como "Ganho".
--
-- Definição reproduz a versão de prod (2026-05-04) e adiciona skip_pos_venda
-- ao FINAL (PostgreSQL bloqueia adicionar coluna no meio via CREATE OR REPLACE).
-- ============================================================================
