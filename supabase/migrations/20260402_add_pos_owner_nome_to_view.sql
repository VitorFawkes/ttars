-- ============================================================================
-- ADD pos_owner_nome to view_cards_acoes
--
-- The view already JOINs profiles for sdr, vendas, concierge, and dono_atual
-- but was missing the JOIN for pos_owner. This adds:
--   1. LEFT JOIN profiles pos_prof ON c.pos_owner_id = pos_prof.id
--   2. pos_prof.nome AS pos_owner_nome in SELECT
-- ============================================================================
