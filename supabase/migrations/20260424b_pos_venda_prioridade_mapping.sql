-- ============================================================================
-- MIGRATION: Fix mapeamento de prioridade nas tarefas da importação pós-venda
-- Date: 2026-04-24
--
-- BUG: A cadência "Pós-venda: App & Conteúdo" tem task_config.prioridade
-- em inglês ('high', 'medium', 'low'), mas a tabela tarefas tem
-- constraint tarefas_prioridade_check que só aceita 'baixa', 'media',
-- 'alta'. Resultado: 400 ao importar.
--
-- Fix: traduzir na inserção. Só ajusta o bloco de criação das 4 tarefas
-- da cadência; resto da RPC permanece igual.
-- ============================================================================
        ...
        ELSE
            ...
            IF v_cadence_template_id IS NOT NULL THEN
                ...
                LOOP
                    ...
                    -- Traduzir prioridade EN → PT (constraint aceita só baixa/media/alta)
