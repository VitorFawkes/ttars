-- ============================================================================
-- MIGRATION: view_cards_acoes — expor sdr_qualification_score_latest
-- Date: 2026-05-12
--
-- Para o KanbanCard mostrar o badge de score SDR (WEDDING) sem N+1 queries,
-- a view consumida pelo Kanban precisa expor a coluna denormalizada criada em
-- 20260512d_sdr_qualifications.sql. CREATE OR REPLACE adiciona apenas no
-- final — preservamos todas as colunas existentes na ordem.
-- Não toca em nada relacionado a agentes IA.
-- ============================================================================
...
SELECT c.id,
    ...
    c.skip_pos_venda,
    c.sdr_qualification_score_latest  -- nova coluna no final
   FROM cards c
