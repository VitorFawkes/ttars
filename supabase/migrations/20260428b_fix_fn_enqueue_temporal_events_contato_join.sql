-- ============================================================
-- Hotfix: fn_enqueue_temporal_events usava cards.contato_id (coluna não
-- existe em produção — migrou para cards_contatos junction). O bloco
-- de contato.data_nascimento estava quebrado silenciosamente desde a
-- migration 20260420d. Substituir join para usar o contato principal
-- via cards_contatos.eh_principal.
-- ============================================================
