-- Lead Ideal × Pipeline (Weddings) — estende o modelo "3 números" pra o cruzamento (heatmap)
-- e pro Top combos, pra unificar a aba inteira.
--
-- Aditivo sobre 20260614a (que já vive em produção):
--   • cruzamento: cada célula ganha hist_leads_qtd/pct (leads que entraram na referência),
--     pra a UI poder alternar a "lente" da comparação (Vendas × Agora, Antes × Agora, etc).
--   • novo top_perfis_unificado: top 12 combos (faixa+destino+convidados) com os 3 números
--     (Vendas / Leads referência / Leads agora), ranqueado por quem mais vendeu.
-- Base: definição viva (20260614a). Linhas existentes byte-idênticas; só inserções marcadas NOVO.
