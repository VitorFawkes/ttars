# Patricia — Prompt preview (versão DEPOIS da migração)

Este documento mostra os 4 blocos que mudaram (principles, boundaries, context_rules/DIFF, data_update_rules). Os outros blocos (header, voice, agent_schedule, playbook, listening, state, etc.) seguem iguais.

> **Tamanho:** principles 9614 + boundaries 2315 + diff 2515 + data_update 3324 = **17768 chars** no total desses 4 blocos.
...
## <boundaries>
## Decisões de marca (linha vermelha)
