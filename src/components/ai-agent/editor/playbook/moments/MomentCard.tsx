...
const ANCHOR_VARIABLES: Array<{ token: string; label: string; hint?: string }> = [
  ...
  { token: '{responsavel_first_name}', label: 'Wedding Planner (1º nome)', hint: 'Primeiro nome do closer (recomendado — soa natural). Ex: "Cyntya" em vez de "Cyntya Joici Nishino de Almeida".' },
  { token: '{responsavel_name}', label: 'Wedding Planner (nome completo)', hint: 'Nome completo do closer configurado em Handoff > Agendar reunião automática. Use só se quiser formal.' },
