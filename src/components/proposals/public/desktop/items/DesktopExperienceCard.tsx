    ...
    >
      <div className="flex">
        ...
        <div className="flex-1 p-5">
          ...
          {/* Opções — Padrão + variantes. Opção SUBSTITUI o preço base. */}
              ...
              <div className="flex gap-2 flex-wrap">
                ...
                >
                  ...
                  <span className="text-xs font-semibold text-slate-700">
                    {formatPrice(experienceData.priceType === 'per_person'
                      ? experienceData.price * experienceData.participants
                ...
                {experienceData.options.map(option => {
                  ...
                  const optTotal = experienceData.priceType === 'per_person'
                    ? option.price * experienceData.participants
                    : option.price
                  return (
                    <button
                      key={option.id}
