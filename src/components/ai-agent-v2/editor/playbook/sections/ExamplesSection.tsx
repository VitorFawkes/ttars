...
import { useAgentFewShotExamples, type PlaybookFewShotExample, type PlaybookExampleInput } from '@/hooks/v2/playbook/useAgentFewShotExamples'
import { useAgentSuggestVariations } from '@/hooks/v2/playbook/useAgentSuggestVariations'
