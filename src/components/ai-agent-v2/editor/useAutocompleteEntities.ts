...
import { useAiSkills } from '@/hooks/v2/useAiSkills'
...
export function useAutocompleteEntities({
  ...
  const assignedSkills = useMemo(() => {
    const src = (agentDetail as unknown as { ai_agent_skills?: Array<{ ai_skills?: import('@/hooks/v2/useAiSkills').AiSkill | null; enabled?: boolean }> } | null)
