...
import { Kanban, Users, Settings, FileText, ChevronRight, User, BarChart3, LogOut, Database, Calendar, CheckSquare, Gift, Shield, MapPin, Building2, Target, Smile, Heart, LibraryBig, type LucideIcon } from 'lucide-react'
...
const navigation: { name: string; href: string; icon: LucideIcon; orgsOnly?: string[]; adminOnly?: boolean; phases?: string[]; roles?: string[] }[] = [
    ...
    { name: 'Pontuações SDR', href: '/sdr/pontuacoes', icon: Target, orgsOnly: ['welcome-weddings'] },
    { name: 'Convidados', href: '/convidados', icon: Heart, orgsOnly: ['welcome-weddings'] },
