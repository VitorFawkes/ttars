...
function SectionFieldDefaultsPicker({ sectionKey }: { sectionKey: string }) {
    ...
    const handleDragEnd = useCallback((event: DragEndEvent) => {
        ...
        // Optimistic update — reflete a nova ordem na UI antes do servidor responder
            ...
            {open && (
                <div className="mt-2 ml-6 space-y-1">
                    <p className="text-[10px] text-muted-foreground/60 mb-2">
                        Defaults para todos os stages. Arraste pelo grip para reordenar. Override por stage no Inspector.
                    </p>
                    <DndContext
                        sensors={sensors}
                        collisionDetection={closestCenter}
