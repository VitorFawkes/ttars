...
import { PhoneLinesPanel } from '@/components/ai-agent-v2/editor/PhoneLinesPanel'
import { useAiAgentHubStats } from '@/hooks/v2/useAiAgentHubStats'
import { useAiAgentMetrics } from '@/hooks/v2/useAiConversations'
import { cn } from '@/lib/utils'
import { AgentEditorLayout, type EditorTab } from '@/components/ai-agent-v2/editor/AgentEditorLayout'
import { TabIdentidade } from '@/components/ai-agent-v2/editor/TabIdentidade'
import { TabPrompts } from '@/components/ai-agent-v2/editor/TabPrompts'
...
import { TabFunilQualificacao } from '@/components/ai-agent-v2/editor/TabFunilQualificacao'
import { TabRegrasNegocio } from '@/components/ai-agent-v2/editor/TabRegrasNegocio'
import { TabCenariosEspeciais } from '@/components/ai-agent-v2/editor/TabCenariosEspeciais'
import { TabModoInteracao } from '@/components/ai-agent-v2/editor/TabModoInteracao'
import { TabApresentacao } from '@/components/ai-agent-v2/editor/TabApresentacao'
import { TabPlaybook } from '@/components/ai-agent-v2/editor/playbook/TabPlaybook'
