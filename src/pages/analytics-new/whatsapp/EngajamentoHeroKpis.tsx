...
export default function EngajamentoHeroKpis({ kpis, isLoading }: Props) {
    ...
    <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
      {cards.map((c, idx) => (
        <div
          key={c.title}
          className={cn(
            'relative overflow-hidden rounded-2xl border border-slate-200 bg-gradient-to-br p-5 ring-1 shadow-sm',
            c.accent,
            c.ring
          )}
          style={{
