...
import { useWwDiretoria, type WwDiretoriaDeal, type WwDiretoriaFase, type WwDiretoriaFaseKey } from '@/hooks/analyticsWeddings/useWw2'
...
export default function DiretoriaPage() {
  ...
  // Estáveis para o React.memo das barras não re-renderizar a cada hover.
        ...
        {isLoading ? (
          ...
          <>
            ...
            <p className="text-[11px] text-ww-n400 pt-2 border-t border-ww-sand">
              Cada tracinho é um casal — passe o mouse para o preview e clique para abrir o card. O número de casais é a foto de agora.
