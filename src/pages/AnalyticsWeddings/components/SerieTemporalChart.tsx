...
export function SerieTemporalChart({
  ...
  // Período curto (≤ ~92 dias) abre por SEMANA pra não virar 1 barra só; longo por MÊS.
  // A visão DIÁRIA fica disponível no botão (Dia/Semana/Mês) — o usuário troca livre.
