...
import { useWw2Overview, useWwAgenda, type Ww2Conversao, type Ww2Alerta, type DrillMarco, type WwAgendaItem, type WwAgendaPorDia, type WwAgendaDesfechos } from '@/hooks/analyticsWeddings/useWw2'
...
function VisaoGeralContent({ filters }: { filters: AppliedFilters }) {
  ...
  return (
    <div className="space-y-5">
      ...
      {/* Alertas — leads parados, com pipeline do Active, filtro e ordenação */}
