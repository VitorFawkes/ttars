...
> **Trigger:** ALWAYS ON
> **Stats:** 207 tabelas | 193 paginas | 299 hooks | 23 views | 762 components
...
> **299 hooks** escaneados de `src/hooks/*.ts` — atualizado automaticamente via `npm run sync:fix`
...
> **193 pages** escaneadas de `src/pages/` — atualizado automaticamente via `npm run sync:fix`
...
<!-- sync: Tue May 19 18:10:26 UTC 2026 -->
<!-- sync: Tue May 19 18:24:07 UTC 2026 -->
<!-- sync: Wed May 20 16:17:38 UTC 2026 -->
